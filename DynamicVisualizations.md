...
<br>The `r pkg("echarty")` package (*echarts.js*) offers an alternative approach, starting with 'ec.init()' and configuring R lists to directly support the *echart.js* API.  A comparison table between *echarts4r* and *echarty* may be found on their Github and website pages. 
